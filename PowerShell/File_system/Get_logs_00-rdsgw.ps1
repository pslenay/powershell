...
Param (
 [string]$Computer = (Read-Host 00-rdsgw),
 [int]$Days = 1
 )
 cls
 $Result = @()
 ...
 $Result | Select Time,"Event Type",User | Sort Time -Descending | Export-Csv "C:\Remote_users_00-rdsgw.csv" -Append
...
get-logonhistory -Computer "00-rdsgw" -Days "1"
